...
import uk.ac.aber.adk15.paper.newapi.constants.FoldedModels._
import uk.ac.aber.adk15.paper.newapi.constants.UnfoldedCreasePatterns._

class NewCreasePatternComplexitySpec extends CommonFlatSpec {
